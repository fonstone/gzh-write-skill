...
如果 mode=tech，额外加载 `{baseDir}/references/tech-frameworks.md`，合并到框架选择列表中（新增 4 套：原理演进/技术对比/实践指南/源码拆解）。
...
```bash
python3 {baseDir}/scripts/l1_hard_rules.py {article_path} --json --mode {mode}
```
