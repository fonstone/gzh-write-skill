...
| 排版发布 | 20 主题 + 微信兼容修复 + 暗黑模式 | `toolkit/cli.py` |
...
| 极简专业（tech 首选） | `tech-pro`、`stripe`、`github`、`linear` |
| 科技 | `tech-modern`、`bytedance`、`wired` |
...
│   ├── style-template.md       # 风格配置字段 + 20 主题列表
