...
| 四套 tech 框架 + 三输出模板 | 原理演进型 / 技术对比型 / 实践指南型 / 源码拆解型 + 概念讲解/实践指南/对比分析三种输出格式 | `references/tech-frameworks.md` |
| 输出模板 | 概念讲解类 / 实践指南类 / 对比分析类，适配七段式骨架和框架体系 | `references/tech-frameworks.md` |
...
│   │
│   ├── tech-writing-guide.md   # [tech] 技术科普写作规范（开头层/行文层/内容层/结尾层 + 叙事驱动 + 说服力驱动 + RISE 节奏 + 可视化优先级）
...
│   ├── tech-frameworks.md      # [tech] 4 套技术科普框架 + 输出模板（概念讲解/实践指南/对比分析）
